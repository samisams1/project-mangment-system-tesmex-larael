            ...
            <form action="{{url('/payslips/update')}}" class="form-submit-event" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-4">
                        ...
                        <input type="text" id="payment_date" name="payment_date" class="form-control" placeholder="<?= get_label('please_select', 'Please select') ?>" value="{{ !is_null($payslip->payment_date)?format_date(date('Y-m-d', strtotime($payslip->payment_date)),false,'Y-m-d',get_php_date_time_format()):'' }}" autocomplete="off">
                    </div>
