        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <a href="#" class="text-success font-weight-bold" style="text-decoration: none;">
                    View Allocate Resource  <span>{{$finace_status}} </span>
                </a>
            </div>
            <div class="card-body">
                            ...
                            <tbody>
                                @foreach($materialRequests as $index => $materialRequest)
                                    <tr>
                                        ...
                                        <td>
                                            <span class="text-muted">{{ $materialRequest->resource_request->finance_status ?? 'N/A' }}</span>
                                        </td>
                                        <td>
                                        ...
                                        <input type="hidden" name="warehouse_id" value="{{ $materialRequest->material->warehouse_id }}">
                                        <input type="hidden" name="item_id" value="{{ $materialRequest->material->id }}">
