...
function progressFormatter(value, row, index) {
    ...
    // Create the progress bar using the actual value for width
    let progressBar = `
    <div class="progress" style="height: 20px;">
        <div class="progress-bar" role="progressbar" style="width: ${value}%; background-color: ${color};" aria-valuenow="${value}" aria-valuemin="0" aria-valuemax="100">
            <span style="font-size: 16px;">${row.progress}</span>
        </div>
    </div>
    `;
